...
return array(
    ...
    'ldap_activated_flag_help'  => 'Cờ này được sử dụng để xác định xem người dùng có thể đăng nhập vào Snipe-IT hay không và không ảnh hưởng đến khả năng kiểm tra các mục vào hoặc chuyển ra của họ.',
