...
<div class="row">
  ...
  <div class="col-lg-4 col-xs-6">
    ...
    <div class="small-box bg-teal">
      ...
      @can('index', \App\Models\Asset::class)
        <a href="{{ url('hardware?purchase_type=high') }}" class="small-box-footer">{{ trans('general.moreinfo') }} <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
      @endcan
    </div>
      </a>
  </div><!-- ./col -->
  <div class="col-lg-4 col-xs-6">
    ...
    <div class="small-box bg-blue">
      <div class="inner">
        <h3>{{ number_format($counts['asset_lva']) }}</h3>
        <p>{{ trans('general.total_assets') }} LVA</p>
      </div>
      <div class="icon" aria-hidden="true">
        <i class="fa fa-barcode" aria-hidden="true"></i>
      </div>
      @can('index', \App\Models\Asset::class)
        <a href="{{ url('hardware?purchase_type=low') }}" class="small-box-footer">{{ trans('general.moreinfo') }} <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
      @endcan
    </div>
      </a>
  </div><!-- ./col -->
...
<div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="text-center text-dark">
                            <h5><b><a href="{{ route('hardware.index') }}"><u class="text-warning">Total Asset = {{ number_format($counts['assets']) }}</u> </a></b></h5>
                        </div>
                    </div> <!-- /.col -->
                </div> <!-- /.row -->
            </div><!-- /.box-body -->
    ...
    <div class="col-md-4">
        <div class="box box-default">
            <div class="box-header with-border">
                <h2 class="box-title">{{ trans('general.assets') }} by Category</h2>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse" aria-hidden="true">
                        <i class="fa fa-minus" aria-hidden="true"></i>
                        <span class="sr-only">Collapse</span>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="text-center">
                            <!--<h3><b>Total Asset = {{ number_format($counts['asset']) }} </b></h2>-->
                        </div>
                    </div> <!-- /.col -->
                </div> <!-- /.row -->
            </div><!-- /.box-body -->
...
<script nonce="{{ csrf_token() }}">
    ...
    // ---------------------------
      ...
      $.ajax({
          type: 'GET',
          url: '{{  route('api.categories.assets.bycategory') }}',
          headers: {
              "X-Requested-With": 'XMLHttpRequest',
              "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr('content')
          },
