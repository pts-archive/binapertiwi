  ...
  <div class="col-md-3">
    <h2>{{ trans('admin/statuslabels/table.about') }}</h2>
      ...
      <div class="box box-primary">
          <div class="box-body">
          <p><i class="fa fa-circle text-blue"></i> <strong>Used</strong>: {!!  trans('admin/statuslabels/message.help.deployable')  !!}</p>
          </div>
      </div>
      
      <div class="box box-success">
          <div class="box-body">
          <p><i class="fa fa-circle text-green"></i> <strong>Ready</strong>: {!!  trans('admin/statuslabels/message.help.ready')  !!}</p>
          </div>
      </div>
      ...
      <div class="box box-danger">
          <div class="box-body">
            <p><i class="fa fa-times text-red"></i> <strong>Rusak</strong>: {{ trans('admin/statuslabels/message.help.undeployable') }}</p>
          </div>
      </div>

      <div class="box box-info">
          <div class="box-body">
              <p><i class="fa fa-times text-red"></i> <strong>Scrap</strong>: {{ trans('admin/statuslabels/message.help.archived') }}</p>
          </div>
      </div>
