      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            @endcan
            @can('index', \App\Models\Asset::class)
            <li class="treeview{{ (Request::is('hardware') && Request::query('status') && Request::query('purchase_type') == 'high' ? ' active' : '') }}" >
                ...
                <ul class="treeview-menu">
                  <li>
                      <a href="{{ url('hardware?purchase_type=high') }}">
                    ...
                    <a href="{{ url('hardware?status=Deployed&purchase_type=high') }}">
                        <i class="fa fa-circle-o text-blue"></i>
                        {{ trans('general.asset_dipakai') }}
                        <!-- {{ trans('general.all') }}
                  ...
                  <li{!! (Request::query('status') == 'RTD' ? ' class="active"' : '') !!}>
                    <a href="{{ url('hardware?status=RTD&purchase_type=high') }}">
                        <i class="fa fa-circle-o text-green"></i>
                        {{ trans('general.asset_ready') }}
                        <!-- {{ trans('general.all') }}
                        {{ trans('general.ready_to_deploy') }} -->
                        ({{ (isset($total_rtd_sidebar)) ? $total_rtd_sidebar : '' }})
                    </a>
                  </li>
                  <li{!! (Request::query('status') == 'Pending' ? ' class="active"' : '') !!}>
                    <a href="{{ url('hardware?status=Pending&purchase_type=high') }}"><i class="fa fa-circle-o text-orange"></i>
                          {{ trans('general.asset_pending') }}
                          <!-- {{ trans('general.all') }}
                          {{ trans('general.pending') }} -->
                          ({{ (isset($total_pending_sidebar)) ? $total_pending_sidebar : '' }})
                      </a>
                  </li>
                  <li{!! (Request::query('status') == 'Undeployable' ? ' class="active"' : '') !!} >
                    <a href="{{ url('hardware?status=Undeployable&purchase_type=high') }}"><i class="fa fa-circle-o text-red"></i>
                          {{ trans('general.asset_rusak') }}
                          <!-- {{ trans('general.all') }}
                  ...
                  <!--  <a href="{{ url('hardware?status=Archived&purchase_type=high') }}"><i class="fa fa-circle-o text-purple"></i>-->
                  <!--        {{ trans('general.asset_scrap') }}-->
                  <!--         {{ trans('general.all') }}-->
              ...
              @endcan 
              @can('index', \App\Models\Asset::class)
            <li class="treeview{{ (Request::is('hardware') && Request::query('status') && Request::query('purchase_type') == 'low' ? ' active' : '') }}">
                <a href="#"><i class="fa fa-barcode" aria-hidden="true"></i>
                  <span>{{ trans('general.assets_lva') }}</span>
                  <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li>
                      <a href="{{ url('hardware?purchase_type=low') }}">
                          <i class="fa fa-circle-o text-grey" aria-hidden="true"></i>
                        {{ trans('general.list_all') }}
                    </a>
                  </li>
                  ...
                  <li{!! (Request::query('status') == 'Deployed' ? ' class="active"' : '') !!}>
                    <a href="{{ url('hardware?status=Deployed&purchase_type=low') }}">
                        <i class="fa fa-circle-o text-blue"></i>
                        {{ trans('general.asset_dipakai2') }}
                        <!-- {{ trans('general.all') }}
                        {{ trans('general.deployed') }} -->
                        ({{ (isset($total_deployed_sidebar_lva)) ? $total_deployed_sidebar_lva : '' }})
                    </a>
                  </li>
                  <li{!! (Request::query('status') == 'RTD' ? ' class="active"' : '') !!}>
                    <a href="{{ url('hardware?status=RTD&purchase_type=low') }}">
                        <i class="fa fa-circle-o text-green"></i>
                        {{ trans('general.asset_ready2') }}
                        <!-- {{ trans('general.all') }}
                        {{ trans('general.ready_to_deploy') }} -->
                        ({{ (isset($total_rtd_sidebar_lva)) ? $total_rtd_sidebar_lva : '' }})
                    </a>
                  </li>
                  <li{!! (Request::query('status') == 'Pending' ? ' class="active"' : '') !!}>
                    <a href="{{ url('hardware?status=Pending&purchase_type=low') }}"><i class="fa fa-circle-o text-orange"></i>
                          {{ trans('general.asset_pending2') }}
                          <!-- {{ trans('general.all') }}
                          {{ trans('general.pending') }} -->
                          ({{ (isset($total_pending_sidebar_lva)) ? $total_pending_sidebar_lva : '' }})
                      </a>
                  </li>
                  <li{!! (Request::query('status') == 'Undeployable' ? ' class="active"' : '') !!} >
                    <a href="{{ url('hardware?status=Undeployable&purchase_type=low') }}"><i class="fa fa-circle-o text-red"></i>
                          {{ trans('general.asset_rusak2') }}
                          <!-- {{ trans('general.all') }}
                          {{ trans('general.undeployable') }} -->
                          ({{ (isset($total_undeployable_sidebar_lva)) ? $total_undeployable_sidebar_lva : '' }})
                      </a>
                  </li>
                  <!--<li{!! (Request::query('status') == 'Archived' ? ' class="active"' : '') !!}>-->
                  <!--  <a href="{{ url('hardware?status=Archived&purchase_type=low') }}"><i class="fa fa-circle-o text-purple"></i>-->
                  <!--        {{ trans('general.asset_scrap2') }}-->
                  <!--         {{ trans('general.all') }}-->
                         <!-- {{ trans('admin/hardware/general.archived') }} -->
                  <!--        ({{ (isset($total_archived_sidebar_lva)) ? $total_archived_sidebar_lva : '' }})-->
                  <!--        </a>-->
                  <!--</li>-->
                    <!-- <li{!! (Request::query('status') == 'Requestable' ? ' class="active"' : '') !!}><a href="{{ url('hardware?status=Requestable') }}"><i class="fa fa-check text-blue"></i>
                        {{ trans('admin/hardware/general.requestable') }}
