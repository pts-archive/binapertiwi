  ...
  <div class="row" id="setting-list">
    ...
    <div class="list">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="box box-default">
            <div class="box-body text-center">
              <h5>
              <a href="<?php echo e(route('settings.branding.index')); ?>">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="<?php echo e(route('settings.general.index')); ?>">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="<?php echo e(route('settings.security.index')); ?>">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="<?php echo e(route('settings.localization.index')); ?>">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="<?php echo e(route('settings.alerts.index')); ?>">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="<?php echo e(route('settings.slack.index')); ?>">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="<?php echo e(route('settings.asset_tags.index')); ?>">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="<?php echo e(route('settings.barcodes.index')); ?>">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="<?php echo e(route('settings.labels.index')); ?>">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="<?php echo e(route('settings.ldap.index')); ?>">
      ...
      <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
        <div class="box box-default">
          <div class="box-body text-center">
            <h5>
              <a href="<?php echo e(route('settings.saml.index')); ?>">
      ...
      <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
        <div class="box box-default">
          <div class="box-body text-center">
            <h5>
              <a href="<?php echo e(route('settings.logins.index')); ?>">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="box box-default">
            <div class="box-body text-center">
              <h5>
              <a href="<?php echo e(route('settings.oauth.index')); ?>">
        ...
        <?php if(config('app.debug')=== true): ?>
          <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
            <div class="box box-default">
              <div class="box-body text-center">
                <h5>
                  <a href="<?php echo e(route('settings.phpinfo.index')); ?>">
    ...
    <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
      <div class="box box-danger">
        <div class="box-body text-center">
          <h5>
            <a href="<?php echo e(route('settings.purge.index')); ?>">
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/binaper1/asset.binapertiwi.co.id/resources/views/settings/index.blade.php ENDPATH**/ ?>