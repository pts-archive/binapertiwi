...
<?php if($item->image): ?>
    <div class="form-group <?php echo e($errors->has('image_delete') ? 'has-error' : ''); ?>">
        ...
        <div class="col-md-5">
            ...
            <img src="<?php echo e(Storage::disk('public')->url(app('components_upload_path').e($item->image))); ?>"  class="img-responsive" />
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/binaper1/asset.binapertiwi.co.id/resources/views/components/edit.blade.php ENDPATH**/ ?>