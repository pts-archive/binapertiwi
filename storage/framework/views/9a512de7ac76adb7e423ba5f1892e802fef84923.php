<?php $__env->startSection('title0'); ?>
    ...
    <?php echo e(trans('general.audit_overdue')); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <table
                                    ...
                                    data-url="<?php echo e(route('api.asset.to-audit', ['audit' => 'overdue'])); ?>"
                                    data-export-options='{
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/binaper1/asset.binapertiwi.co.id/resources/views/hardware/audit-overdue.blade.php ENDPATH**/ ?>