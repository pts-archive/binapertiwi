                ...
                <div class="box-body">
                    ...
                    <div class="col-md-11 col-md-offset-1">
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_integration') ? 'error' : ''); ?>">
                            <div class="col-md-3">
                                <?php echo e(Form::label('ldap_integration', trans('admin/settings/general.ldap_integration'))); ?>

                            </div>
                            <div class="col-md-9">

                                <?php echo e(Form::checkbox('ldap_enabled', '1', Request::old('ldap_enabled', $setting->ldap_enabled), [((config('app.lock_passwords')===true)) ? 'disabled ': '', 'class' => 'minimal '. $setting->demoMode, $setting->demoMode])); ?>

                                <?php echo e(trans('admin/settings/general.ldap_enabled')); ?>

                                <?php if(config('app.lock_passwords')===true): ?>
                                    <p class="text-warning"><i class="fa fa-lock" aria-hidden="true"></i> <?php echo e(trans('general.feature_disabled')); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group <?php echo e($errors->has('ad_domain') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ad_domain', Request::old('ad_domain', $setting->ad_domain), ['class' => 'form-control','placeholder' => 'example.com', $setting->demoMode])); ?>
                        ...
                        <div class="form-group">
                            <div class="col-md-3">
                                <?php echo e(Form::label('ad_append_domain', trans('admin/settings/general.ad_append_domain_label'))); ?>

                            </div>
                            <div class="col-md-9">
                                <?php echo e(Form::checkbox('ad_append_domain', '1', Request::old('ad_append_domain', $setting->ad_append_domain),['class' => 'minimal '. $setting->demoMode, $setting->demoMode])); ?>

                                <?php echo e(trans('admin/settings/general.ad_append_domain')); ?>

                                <p class="help-block"><?php echo e(trans('admin/settings/general.ad_append_domain_help')); ?></p>
                                <?php echo $errors->first('ad_append_domain', '<span class="alert-msg">:message</span>'); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_server') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_server', Request::old('ldap_server', $setting->ldap_server), ['class' => 'form-control','placeholder' => 'ldap://ldap.example.com', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_uname') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_uname', Request::old('ldap_uname', $setting->ldap_uname), ['class' => 'form-control','placeholder' => 'binduser@example.com', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_pword') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::password('ldap_pword', ['class' => 'form-control','placeholder' => 'binduserpassword', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_basedn') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_basedn', Request::old('ldap_basedn', $setting->ldap_basedn), ['class' => 'form-control', 'placeholder' => 'cn=users/authorized,dc=example,dc=com', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_filter') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_filter', Request::old('ldap_filter', $setting->ldap_filter), ['class' => 'form-control','placeholder' => '&(cn=*)', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_username_field') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_username_field', Request::old('ldap_username_field', $setting->ldap_username_field), ['class' => 'form-control','placeholder' => 'samaccountname', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_lname_field') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_lname_field', Request::old('ldap_lname_field', $setting->ldap_lname_field), ['class' => 'form-control','placeholder' => 'sn', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_fname_field') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_fname_field', Request::old('ldap_fname_field', $setting->ldap_fname_field), ['class' => 'form-control', 'placeholder' => 'givenname', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_auth_filter_query') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_auth_filter_query', Request::old('ldap_auth_filter_query', $setting->ldap_auth_filter_query), ['class' => 'form-control','placeholder' => '"uid="', $setting->demoMode])); ?>
                        ...
                        <!-- LDAP Version -->
                        <div class="form-group <?php echo e($errors->has('ldap_version') ? 'error' : ''); ?>">
                            <div class="col-md-3">
                                <?php echo e(Form::label('ldap_version', trans('admin/settings/general.ldap_version'))); ?>

                            </div>
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_version', Request::old('ldap_version', $setting->ldap_version), ['class' => 'form-control','placeholder' => '3', $setting->demoMode])); ?>

                                <?php echo $errors->first('ldap_version', '<span class="alert-msg" aria-hidden="true">:message</span>'); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_active_flag') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_active_flag', Request::old('ldap_active_flag', $setting->ldap_active_flag), ['class' => 'form-control','placeholder' => '', $setting->demoMode])); ?>


                                <p class="help-block"><?php echo e(trans('admin/settings/general.ldap_activated_flag_help')); ?></p>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_emp_num') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_emp_num', Request::old('ldap_emp_num', $setting->ldap_emp_num), ['class' => 'form-control','placeholder' => 'employeenumber/employeeid', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_dept') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_dept', Request::old('ldap_dept', $setting->ldap_dept), ['class' => 'form-control','placeholder' => 'department', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_email') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_email', Request::old('ldap_email', $setting->ldap_email), ['class' => 'form-control','placeholder' => 'mail', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_phone') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_phone', Request::old('ldap_phone', $setting->ldap_phone_field), ['class' => 'form-control','placeholder' => 'telephonenumber', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_jobtitle') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_jobtitle', Request::old('ldap_jobtitle', $setting->ldap_jobtitle), ['class' => 'form-control','placeholder' => 'title', $setting->demoMode])); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('ldap_country') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('ldap_country', Request::old('ldap_country', $setting->ldap_country), ['class' => 'form-control','placeholder' => 'c', $setting->demoMode])); ?>
                        ...
                        <?php if($setting->ldap_enabled): ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9" id="ldaptestrow">
                                    <a <?php echo e($setting->demoMode); ?> class="btn btn-default btn-sm pull-left" id="ldaptest" style="margin-right: 10px;">Test LDAP Synchronization</a>
                                </div>
                       ...
                       <?php endif; ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('custom_forgot_pass_url') ? 'error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <?php echo e(Form::text('custom_forgot_pass_url', Request::old('custom_forgot_pass_url', $setting->custom_forgot_pass_url), ['class' => 'form-control','placeholder' => 'https://my.ldapserver-forgotpass.com', $setting->demoMode])); ?>
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/binaper1/asset.binapertiwi.co.id/resources/views/settings/ldap.blade.php ENDPATH**/ ?>