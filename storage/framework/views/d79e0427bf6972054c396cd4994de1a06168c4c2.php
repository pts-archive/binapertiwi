  ...
  <div class="col-md-3">
    <h2><?php echo e(trans('admin/statuslabels/table.about')); ?></h2>
      ...
      <div class="box box-primary">
          <div class="box-body">
          <p><i class="fa fa-circle text-blue"></i> <strong>Used</strong>: <?php echo trans('admin/statuslabels/message.help.deployable'); ?></p>
          </div>
      </div>
      
      <div class="box box-success">
          <div class="box-body">
          <p><i class="fa fa-circle text-green"></i> <strong>Ready</strong>: <?php echo trans('admin/statuslabels/message.help.ready'); ?></p>
          </div>
      </div>
      ...
      <div class="box box-danger">
          <div class="box-body">
            <p><i class="fa fa-times text-red"></i> <strong>Rusak</strong>: <?php echo e(trans('admin/statuslabels/message.help.undeployable')); ?></p>
          </div>
      </div>

      <div class="box box-info">
          <div class="box-body">
              <p><i class="fa fa-times text-red"></i> <strong>Scrap</strong>: <?php echo e(trans('admin/statuslabels/message.help.archived')); ?></p>
          </div>
      </div>
...
<?php echo $__env->make('layouts/default', [
    ...
    'helpPosition' => 'right',
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/binaper1/asset.binapertiwi.co.id/resources/views/statuslabels/index.blade.php ENDPATH**/ ?>