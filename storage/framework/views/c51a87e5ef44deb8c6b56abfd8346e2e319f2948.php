    ...
    $(function() {
        $('#assigned_user').on("change",function () {
            ...
            if(userid=='') {
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo e(url('/')); ?>/api/v1/users/' + userid + '/assets',
                    headers: {
                    ...
                    success: function (data) {
                        ...
                        if (data.rows.length > 0) {
                            ...
                            for (var i in data.rows) {
                                ...
                                table_html += '<td><a href="<?php echo e(url('/')); ?>/hardware/' + asset.id + '">';
...
<?php /**PATH /home1/binaper1/asset.binapertiwi.co.id/resources/views/partials/assets-assigned.blade.php ENDPATH**/ ?>