...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 class="modal-title"><?php echo e(trans('admin/statuslabels/table.create')); ?></h4>
        </div>
...
<?php /**PATH /home/binaper1/asset.binapertiwi.co.id/resources/views/modals/statuslabel.blade.php ENDPATH**/ ?>