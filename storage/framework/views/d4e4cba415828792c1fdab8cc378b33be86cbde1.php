                            ...
                            <?php if(($snipeSettings->show_images_in_email=='1' ) && ($snipeSettings::setupCompleted())): ?>
                                ...
                                <?php if($snipeSettings->brand == '3'): ?>
                                    <?php if($snipeSettings->logo!=''): ?>
                                        <img class="navbar-brand-img logo" style="max-width: 50px;" src="<?php echo e(url('/')); ?>/uploads/<?php echo e($snipeSettings->logo); ?>">
                                    <?php endif; ?>
                                ...
                                <tr>
                                    <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-footer_cell']); ?>">
                                        <p style="<?php echo e($style['paragraph-sub']); ?>">
                                            ...
                                            <a style="<?php echo e($style['anchor']); ?>" href="<?php echo e(url('/')); ?>" target="_blank"><?php echo e($snipeSettings->site_name); ?></a>.
                                            All rights reserved.
                                        </p>
...
<?php /**PATH /home/binaper1/asset.binapertiwi.co.id/resources/views/vendor/notifications/email.blade.php ENDPATH**/ ?>