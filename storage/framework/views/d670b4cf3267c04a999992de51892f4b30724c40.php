...
<body class="hold-transition login-page">
    ...
    <?php if(($snipeSettings) && ($snipeSettings->logo!='')): ?>
        <center>
            <img id="login-logo" src="<?php echo e(Storage::disk('public')->url('').e($snipeSettings->logo)); ?>">
        </center>
    <?php endif; ?>
  <!-- Content -->
...
<?php /**PATH /home1/binaper1/asset.binapertiwi.co.id/resources/views/layouts/basic.blade.php ENDPATH**/ ?>