  ...
  <div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-teal">
      ...
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('index', \App\Models\Asset::class)): ?>
        <a href="<?php echo e(route('hardware.index')); ?>" class="small-box-footer"><?php echo e(trans('general.moreinfo')); ?> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
      <?php endif; ?>
    </div>
      </a>
  </div><!-- ./col -->
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h2 class="box-title">Asset <?php echo e(trans('general.categories')); ?></h2>
                <div class="box-tools pull-right">
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/binaper1/asset.binapertiwi.co.id/resources/views/dashboard.blade.php ENDPATH**/ ?>