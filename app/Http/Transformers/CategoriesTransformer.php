...
class CategoriesTransformer
{
    ...
    {
        $catArr = [
            'asset' => (int) $category->assets_count,
            'accessory' => (int) $category->accessories_count,
            'license' => (int) $category->licenses_count,
        ];
        ...
        if ($category) {
            ...
            $array = [
                ...
                'assets_count' => (int) $catArr[$category->category_type],
